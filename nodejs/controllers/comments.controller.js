...
exports.list = function(request, response) {
    var sql = 'SELECT * AS full_name FROM `godakond-comments`'
     runSql(sql, response)
}

exports.findUser =  function(request, response){
        var sql = 'SELECT * FROM `godakond-comments` WHERE id='+request.params.id
        runSql(sql, response)
    }

exports.delete =  function(request, response){
        var sql = 'DELETE FROM `godakond-comments` WHERE id='+request.params.id
        runSql(sql, response)
