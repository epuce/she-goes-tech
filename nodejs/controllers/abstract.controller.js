...
function AbstractController() {
    ...
    this.update = async function(request, response) {
        ...
        await app.db.query("SELECT COLUMN_NAME FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'KristePe-users'", function(error, data) {
