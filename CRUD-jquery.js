$(function () {
  ...
  function saveForm() {
    ...
    $nameInput.toggleClass("validation-error", !user.isValidUser());
  ...
  function renderTable() {
    ...
    list.forEach(function (user, index) {
      ...
      var $row = $($('.js-row-template').html())
       ...
       $row.find('.js-index').text(userInstance.email)
    ...
    //       $saveBtn.data('index', button.dataset.index) = button.dataset.index;
    //     });
    //   });
  }
