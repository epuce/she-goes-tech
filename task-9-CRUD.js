...
function renderTaskList() {
  ...
  list.forEach(function (task, index) {
    var row =
      `<div class="js-container-div"><div class="js-list-item-div"><li>` +
      task.taskItem +
      `</li></div><div class="js-button-div"><button class="js-edit" data-index="` +
      index +
      `">Edit</button><input type="checkbox" class="js-check-done" data-index="` +
      index +
      `"></input></div></div>`;
  ...
  document
    .querySelectorAll(".js-task-list .js-check-done")
  ...
  document
    .querySelectorAll(".js-task-list .js-edit")
